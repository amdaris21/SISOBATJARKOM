            ...
            <div class="w-full bg-white border border-[#CAC7C6] rounded-[15px] overflow-hidden shadow-sm">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="px-6 py-4 flex items-center justify-between border-b border-[#AFABAA] hover:bg-red-50 transition-colors group cursor-default">
                        <div class="w-5/12 text-[14px] md:text-[15px] text-black">{{ $quiz->title }}</div>
                        <div class="w-2/12 flex justify-center">
                            <span class="bg-[#C9373F] border border-white text-white font-josefin font-bold text-[12px] px-4 py-1 rounded-[12px]">{{ $quiz->question_count ?? 10 }} Soal</span>
                        </div>
                        <div class="w-2/12 flex justify-center">
                            @php
                                $levelColors = [
                                ...
                                $colorClass = $levelColors[$quiz->level ?? 'Easy'] ?? 'bg-[#CAFCDF] text-[#30D46F]';
                            @endphp
                            <span class="{{ $colorClass }} border border-white font-josefin font-bold text-[12px] px-4 py-1 rounded-[12px]">{{ $quiz->level ?? 'Easy' }}</span>
                        </div>
                        <div class="w-3/12 flex justify-center items-center gap-4">
                            <a href="{{ route('admin.quizzes.edit', $quiz->id) }}" class="flex flex-col items-center group/btn hover:-translate-y-0.5 transition-transform">
                    ...
                    <form action="{{ route('admin.quizzes.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                            <div>
                                ...
                                <input type="number" name="question_count" class="w-full bg-white border border-[#A5A5A5] rounded-[8px] h-[38px] md:h-[42px] px-4 text-[13px] md:text-[14px] focus:outline-none focus:border-[#B7131A] shadow-[0px_2px_4px_#E2E2E2]" required>
                            </div>
                            <div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="w-full bg-white border border-[#A5A5A5] rounded-[8px] h-[80px] md:h-[100px] p-3 text-[13px] md:text-[14px] resize-none focus:outline-none focus:border-[#B7131A] shadow-[0px_2px_4px_#E2E2E2]" required></textarea>
                        </div>
                        
                        <div class="mb-3">
                            <label class="block text-[13px] md:text-[14px] text-[#4E342E] mb-1 font-normal">Instruksi <span class="text-[#B7131A]">Quiz</span></label>
                            <textarea name="instruction" class="w-full bg-white border border-[#A5A5A5] rounded-[8px] h-[60px] md:h-[80px] p-3 text-[13px] md:text-[14px] resize-none focus:outline-none focus:border-[#B7131A] shadow-[0px_2px_4px_#E2E2E2]"></textarea>
                        </div>

                        <div class="grid grid-cols-1 gap-x-4 gap-y-6 mb-2">
                            <div class="flex flex-col gap-4">
                                <div>
                                    <label class="block text-[13px] md:text-[14px] text-[#4E342E] mb-1 font-normal">Link <span class="text-[#B7131A]">Quiz Zep</span></label>
                                    <div class="relative">
                                        ...
                                        <input type="url" name="zep_link" placeholder="Masukkan Link Quiz" class="w-full bg-white border border-[#B8B8B8] rounded-[8px] h-[38px] md:h-[42px] pl-10 pr-4 text-[13px] md:text-[14px] focus:outline-none focus:border-[#B7131A] shadow-[0px_2px_4px_#E2E2E2] placeholder-[#A5A5A5]">
                                    </div>
                                </div>
