            ...
            <div class="bg-white border border-[#B8B8B8] rounded-[15px] shadow-[4px_4px_10px_rgba(0,0,0,0.05)] p-8 md:p-12 flex flex-col-reverse md:flex-row items-center gap-10 md:gap-16 relative overflow-hidden">
                <div class="flex-1 space-y-5 z-10">
                    ...
                    <div class="flex flex-wrap gap-4 pt-3">
                        ...
                        <a href="#" class="inline-flex items-center gap-2 px-6 py-2 bg-white border border-[#B8B8B8] text-black rounded-full font-medium text-[14px] hover:bg-gray-50 transition shadow-sm">
                            Kerjakan Quiz
                        </a>
                    </div>
                </div>
...
\
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div class="bg-white border border-[#B8B8B8] shadow-sm rounded-[10px] p-6 flex flex-row items-center gap-6 relative overflow-hidden">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="text-[26px] font-semibold text-black leading-none drop-shadow-sm">5 <span class="text-[18px] text-gray-500 font-normal mx-0.5">/</span> <span class="text-[22px] font-normal">9</span></div>
                ...
                <div class="bg-white border border-[#B8B8B8] shadow-sm rounded-[10px] p-6 flex flex-row items-center gap-6 relative overflow-hidden">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="text-[26px] font-semibold text-black leading-none drop-shadow-sm">4 <span class="text-[18px] text-gray-500 font-normal mx-0.5">/</span> <span class="text-[22px] font-normal">9</span></div>
    ...
    <section class="w-full bg-gradient-to-b from-[#FFC233] via-[#F8D279] to-[#EFE4CA] py-20 text-center">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 flex flex-col items-center">
            ...
            <a href="#" class="inline-flex items-center gap-2 px-8 py-2 bg-[#B7131A] text-white rounded-full font-medium text-[15px] hover:bg-[#8A070D] transition shadow-sm border border-[#7F1010]">
                Lihat 
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full mb-10">
        ...
        <div class="flex justify-end mt-6 lg:px-8">
             <a href="#" class="inline-flex items-center gap-2 px-6 py-2 bg-[#B7131A] text-white rounded-full font-medium text-[14px] hover:bg-[#8A070D] transition shadow-sm border border-[#7F1010]">
