...
<body class="antialiased text-[#4E342E] min-h-screen flex flex-col">
    ...
    <main class="flex-grow w-full pb-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10">
            ...
            <div x-data="{ currentSlide: 0, totalSlides: 2 }">
                <div class="overflow-hidden w-full relative">
                    <div class="flex transition-transform duration-500 ease-in-out w-full" :style="'transform: translateX(-' + (currentSlide * 100) + '%)'">
                        <!-- Slide 1 -->
                        <div class="w-full shrink-0 grid grid-cols-1 md:grid-cols-2 gap-8 lg:px-8 mb-12">
                ...
                <div class="flex justify-center gap-4 mb-20">
                    <button @click="if(currentSlide > 0) currentSlide--" :class="{ 'opacity-50 cursor-not-allowed': currentSlide === 0 }" class="w-[41px] h-[50px] bg-[#D9D9D9] border border-[#625D5C] rounded-[10px] flex items-center justify-center hover:bg-gray-300 transition">
                    ...
                    <button @click="if(currentSlide < totalSlides - 1) currentSlide++" :class="{ 'opacity-50 cursor-not-allowed': currentSlide === totalSlides - 1 }" class="w-[41px] h-[50px] bg-[#D9D9D9] border border-[#625D5C] rounded-[10px] flex items-center justify-center hover:bg-gray-300 transition">
