...
<head>
    ...
    <title>Register - SISOBATJARKOM</title>
    ...
    <main class="flex-grow flex items-center justify-center py-16 px-4">
        ...
        <div class="w-full max-w-[837px] bg-white border border-[#B8B8B8] shadow-[4px_4px_4px_rgba(0,0,0,0.25)] rounded-[10px] p-8 md:p-14 flex flex-col md:flex-row gap-12 sm:gap-16 items-center justify-center">
            ...
            <div class="flex-1 w-full max-w-[337px] bg-white border border-[#B8B8B8] shadow-[0px_4px_4px_rgba(183,19,26,0.5)] rounded-[10px] px-6 py-8">
                <h2 class="text-[#8A070D] text-[20px] font-medium mb-2">Sign Up</h2>
                <p class="text-black text-[16px] mb-6 leading-[20px]">Silakan daftar dan mulai belajar hari ini.</p>

                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    @csrf
                    
                    <div>
                        <label for="name" class="block text-[14px] leading-[18px] text-black mb-1">Nama</label>
                        <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" class="w-full h-[30px] px-3 bg-[rgba(255,204,207,0.2)] border border-[#B8B8B8] rounded-[10px] focus:outline-none focus:border-[#B7131A] focus:ring-1 focus:ring-[#B7131A] placeholder-[#AFABAA] text-[14px]" placeholder="nama kamu">
                        @error('name')
                    ...
                    <div>
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="username" class="w-full h-[30px] px-3 bg-[rgba(255,204,207,0.2)] border border-[#B8B8B8] rounded-[10px] focus:outline-none focus:border-[#B7131A] focus:ring-1 focus:ring-[#B7131A] placeholder-[#AFABAA] text-[14px]" placeholder="nama@gmail.com">
                        @error('email')
                            <span class="text-xs text-[#B7131A] mt-1">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input id="password" type="password" name="password" required autocomplete="new-password" class="w-full h-[30px] px-3 bg-[rgba(255,204,207,0.2)] border border-[#B8B8B8] rounded-[10px] focus:outline-none focus:border-[#B7131A] focus:ring-1 focus:ring-[#B7131A] placeholder-[#AFABAA] text-[14px]" placeholder="********">
                        @error('password')
                            <span class="text-xs text-[#B7131A] mt-1">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-[14px] leading-[18px] text-black mb-1">Konfirmasi Password</label>
                        <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password" class="w-full h-[30px] px-3 bg-[rgba(255,204,207,0.2)] border border-[#B8B8B8] rounded-[10px] focus:outline-none focus:border-[#B7131A] focus:ring-1 focus:ring-[#B7131A] placeholder-[#AFABAA] text-[14px]" placeholder="********">
                    ...
                    <div class="pt-3 flex justify-end">
                        <button type="submit" class="px-6 py-1 bg-[#B7131A] border border-[#7F2727] text-white rounded-full font-medium text-[16px] hover:bg-[#8A070D] transition shadow-sm">
                            Daftar
                        </button>
                    </div>

                    <div class="mt-4 pt-3 border-t border-[#E4E3E2] flex justify-center text-[14px] gap-1.5">
                        <span class="text-black">Sudah punya akun?</span>
                        <a href="{{ route('login') }}" class="text-[#6AB1F7] hover:underline underline-offset-2">Masuk</a>
                    </div>
                </form>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                ...
                <div class="flex flex-col">
                    ...
                    <a href="https://discord.gg/example" target="_blank" class="inline-flex items-center gap-3 bg-white border border-[#B8B8B8] rounded-full pl-1 pr-6 py-1 mb-6 hover:bg-gray-50 transition self-start">
                ...
                <div>
                    ...
                    <a href="javascript:void(0)" onclick="alert('Fitur ini sedang dalam tahap pengembangan!')" class="text-[#B7131A] text-[16px] hover:underline font-medium inline-flex items-center gap-1">
